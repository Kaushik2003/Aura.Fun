...
echo ""
echo "Minting tokens..."
cast send $VAULT1 "mintTokens(uint256)" 5000000000000000000 --value 0.1ether --rpc-url $RPC_URL --private-key $FAN1_KEY
cast send $VAULT2 "mintTokens(uint256)" 3000000000000000000 --value 0.1ether --rpc-url $RPC_URL --private-key $FAN1_KEY
